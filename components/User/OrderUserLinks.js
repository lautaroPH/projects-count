...
const OrderUserLinks = () => {
  ...
  return (
    <Menu
      as="div"
      className="absolute right-0 flex items-center justify-end pr-2 h-7"
    >
      <div>
        <Menu.Button className="flex items-center text-sm font-light text-gray-500 dark:text-gray-300">
          <span className="ml-1 text-sm lg:text-base font-extralight text-violet-700 dark:text-white">
            {value}
          </span>
          <ChevronDownIcon
