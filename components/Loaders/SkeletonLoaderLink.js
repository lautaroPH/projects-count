...
const SkeletonLoaderLink = () => {
  return (
    <div
      className="overflow-hidden my-2 w-full border-gray-100 rounded-xl 
    ...
    >
      <div className="flex-1">
        ...
        <div className="pl-4 mt-2">
          ...
          <div className="h-24 w-[97%] bg-slate-400 dark:bg-gray-700 rounded mb-2"></div>
        ...
        <div className="h-72 w-full">
          <div className="h-full w-full bg-slate-400 dark:bg-gray-700 rounded"></div>
        </div>
